...
BOT_TOKEN = environ.get('BOT_TOKEN', "7012334247:AAEuYh5F8hPxQaedaV8b1V5z90Al_DcY95k")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))

PICS = (environ.get('PICS', 'https://graph.org/file/1b45720c346b14dd0fbe6.jpg')).split() #SAMPLE PIC
DONATE_PIC = (environ.get('DONATE_PIC', 'https://graph.org/file/31baff43a2e14a84fb050.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001544742746') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nayawala:nayawala@cluster0.apcjpfo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'dfdf43330133221b93ac3a7e4aee1049df12c3dc')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://back-trude-chjjkkjdkf-3660824f.koyeb.app/")
