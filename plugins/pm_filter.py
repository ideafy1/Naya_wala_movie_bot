...
async def pm_text(bot, message):
        ...
        try:
            ...
            if not link:
                ...
                if PM_SEARCH == True:
                    ...
                    await message.reply_text(text=f"<b>oh sorry {user} 👀 ,\n\nrequest that here 👉🏻 <a href=https://t.me/yedekho>YeDekho Movies</a> \n\nअरे यार {user}\n\nजो चाहिए इसमें बोलो 👉🏻 <a href=https://t.me/yedekho>YeDekho Movies</a></b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔎 Search Here", url=f"https://telegram.me/yedekho")]]))
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>oh sorry {user} 👀 ,\n\nrequest that here 👉🏻 <a href=https://t.me/yedekho>YeDekho Movies</a> \n\nअरे यार {user}\n\nजो चाहिए इसमें बोलो 👉🏻 <a href=https://t.me/yedekho>YeDekho Movies</a></b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔎 Search Here", url=f"https://telegram.me/yedekho</b>")]]))
        await bot.send_message(chat_id=LOG_CHANNEL, text=f"<b>#𝐏𝐌_𝐌𝐒𝐆\n\nNᴀᴍᴇ : {user}\n\nID : {user_id}\n\nMᴇssᴀɢᴇ : {content}</b>")
